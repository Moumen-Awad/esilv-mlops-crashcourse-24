...
def train_model_workflow(
    ...
    X_train, y_train, dv = process_data(filepath=data_filepath, with_target=True)
    logger.info("Processing test data...")
    X_test, y_test, _ = process_data(filepath=data_filepath, with_target=True, dv=dv)
    ...
    return {"model": model, "dv": dv, "accuarcy": accuarcy}
